...
insertR (pnodo t)
{
  ...
  if (t->bal < -1)
    ...
    /* Quedó desbalanceado con -1 ó +1 Caso b */
...
pnodo
DescartarAVL (int clave, pnodo t)
{
...
void
inorder (pnodo t, int profundidad)
{
