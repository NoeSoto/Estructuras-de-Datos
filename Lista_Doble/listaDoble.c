...
void
ListaDoble_inicializacion (struct ListaDob *lista)
{
  lista->inicio = NULL;
  lista->fin = NULL;
  lista->tamano = 0;
...
int
ListaDoble_insercion_en_lista_vacia (struct ListaDob *lista, int dato)
{
  if (lista->tamano == 0)
    {
      struct ListaDob *nuevo_elemento;
      if ((nuevo_elemento =
	   (struct ListaDob *) malloc (sizeof (struct ListaDob))) == NULL)
	return -1;
  ...
  else
    {
      ...
      printf
	("Utilice alguna de las siguientes funciones: 1) inserci—n al inicio, 2) al final de la lista, 3) antes o 4)despuŽs de una posici—n");
    }
  return 0;
}
...
int
ListaDoble_ins_inicio_lista (struct ListaDob *lista, int dato)
{
  struct ListaDob *nuevo_elemento;
  if ((nuevo_elemento =
       (struct ListaDob *) malloc (sizeof (struct ListaDob))) == NULL)
...
int
ListaDoble_ins_fin_lista (struct ListaDob *lista, int dato)
{
  struct ListaDob *nuevo_elemento;
  if ((nuevo_elemento =
       (struct ListaDob *) malloc (sizeof (struct ListaDob))) == NULL)
...
int
ListaDoble_ins_antes (struct ListaDob *lista, int dato, int pos)
{
  int i;
...
int
ListaDoble_ins_despues (struct ListaDob *lista, int dato, int pos)
{
  int i;
  struct ListaDob *nuevo_elemento, *actual;
  if ((nuevo_elemento =
...
void
ListaDoble_visualiza_adelante (struct ListaDob *lista)
{
...
void
ListaDoble_visualiza_atras (struct ListaDob *lista)
{
  struct ListaDob *actual;
...
int
ListaDoble_eliminar (struct ListaDob *lista, int pos)
{
  int i;
...
char
ListaDoble_ver_caracter (struct ListaDob *lista, int pos)
{
  struct ListaDob *actual;
  actual = lista->inicio;	//punto de inicio el 1er elemento
  int contador = 0;
